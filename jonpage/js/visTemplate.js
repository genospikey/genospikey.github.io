...
Visualizer.prototype.start = function(stage){
    ...
    this.stage = stage;
    this.waveformSprite.anchor.set(0.5,0.3);
...
Visualizer.prototype.update = function(){
    ...
    this.waveform.clear();
    //this.waveform.beginFill(Math.floor(Math.random() * 0x0000FF));
    this.waveform.fillAlpha = .5;
    this.waveform.lineStyle(10,this.colorShift.current, 1,0);
    // draw waveform
