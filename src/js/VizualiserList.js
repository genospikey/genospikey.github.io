...
export default class VizualiserList {
    ...
    constructor() {
        this.list = [];
        this.list[0] = {class: VizualiserLeftWaveform, name: 'Left Waveform', description: 'A vertical waveform on the left side of the screen'};
        this.list[7] = {class: VizualiserSquare, name: 'Bounce', description: 'Be mesmerized by the bouncing square...'};
