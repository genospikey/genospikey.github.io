...
VisualizerMirror.prototype.start = function(stage){
    ...
    for(var x = 0; x<this.trailLength; x++){
        ...
        //flip y
        this.waveformHistoryTopSprites[x].scale.y = -1;
    ...
    helpText.text = 'Reflect upon the reflection';
}
...
VisualizerMirror.prototype.update = function(){
    ...
    this.waveform.moveTo(WindowWidth,WindowHeight*2);
    this.waveform.lineTo(0,WindowHeight*2);
